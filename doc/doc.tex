...
\begin{document}
    ...
    \begin{table}[h]
        ...
        Doba za kterou cvrček dospěje (od narození)            & (No) 4 týdny          & Ing. Olga Kavánková                   \\ \hline
        Doba za kterou je cvrček vhodný k prodeji              & (No) 4 týdny          & Převazato z [\ref{kniha}]             \\ \hline
        Počet nakladených vajec od jedné samice denně          & (No) 10               & Převazato z [\ref{kniha}]             \\ \hline
        Procentuální úspěšnost vylíhnutí z vajíčka             & 90 \%                 & Ing. Olga Kavánková                   \\ \hline
        Doba za kterou se cvrček vylíhne z nakladeného vajíčka & (No) 2 týdny          & Převazato z [\ref{kniha}]             \\ \hline
        Celková doba života cvrčka                             & (No) 12 týdnů         & Ing. Olga Kavánková                   \\ \hline
        ...
        Hmotnost jídla, co sní crvček starý 0 - 4 týdny        & (No) 0,016 g          & Převazato z [\ref{jidlo}]             \\ \hline
        Hmotnost jídla, co sní cvrček starší 4 týdnů           & (No) 0,034 g          & Převazato z [\ref{jidlo}]             \\ \hline
